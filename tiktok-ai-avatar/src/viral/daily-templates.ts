...
export const DAILY_TEMPLATES: Record<string, ViralVideoProps> = {
  ...
  "Viral-16-Story-WhatIGotWrongAboutNumber4": {
    ...
    music: MUSIC.hardstyleV10,
    structure: { hook: 2.4, build: 8, value: 14.8, cta: 2.8 },
    palette: "ink-violet",
    layout: "split",
  },
  ...
  "Viral-17-Educational-BirthVsDestinyIn15Seconds": {
    ...
    music: MUSIC.cashFlowAnthem,
    structure: { hook: 1.8666666666666667, build: 6.5, value: 12.533333333333333, cta: 2.3333333333333335 },
    palette: "sage-gold",
    layout: "grid",
  },
  ...
  "Viral-19-CommentBait-TagSomeoneWhoIsDefinitelyA7": {
    ...
    structure: { hook: 1.7333333333333334, build: 5.133333333333334, value: 10.3, cta: 2.6 },
    palette: "ink-violet",
    layout: "split",
  },
